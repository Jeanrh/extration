...
INSERT INTO finding_risk AS r (
    ...
    sigla, pci, bia, criticality_cmdb, unidade_negocio, tribo,
    equipe_solucionadora,
...
ON CONFLICT (finding_id) DO UPDATE SET
    ...
    tribo             = EXCLUDED.tribo,
    equipe_solucionadora = EXCLUDED.equipe_solucionadora,
...
WHERE  (r.py, r.px, r.quadrant, r.priority_id, r.priority_name, r.sla_status,
        ...
        r.tribo, r.equipe_solucionadora,
   ...
   IS DISTINCT FROM
       (EXCLUDED.py, EXCLUDED.px, EXCLUDED.quadrant, EXCLUDED.priority_id,
        ...
        EXCLUDED.unidade_negocio, EXCLUDED.tribo, EXCLUDED.equipe_solucionadora,
        EXCLUDED.arch_type, EXCLUDED.layer,
